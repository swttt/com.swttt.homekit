...
module.exports = {
  ...
  homealarm_state:           [
    _('homealarm_state', Characteristic.SecuritySystemCurrentState,
      v => [ 'partially_armed', 'armed', 'partially_armed', 'disarmed', 'armed' ][v],
      v => ( { armed : 1, disarmed : 3, partially_armed : 0 }[v] ),
    ),
    _('homealarm_state', Characteristic.SecuritySystemTargetState,
      v => [ 'partially_armed', 'armed', 'partially_armed', 'disarmed', 'armed' ][v],
      v => ( { armed : 1, disarmed : 3, partially_armed : 0 }[v] ),
    ),
  ],
  ...
  locked:                    [
    _('locked', Characteristic.LockCurrentState, v => v === 1, v => Number(v)),
    _('locked', Characteristic.LockTargetState,  v => v === 1, v => Number(v)),
  ],
  ...
  thermostat_mode:           [
    _('thermostat_mode', Characteristic.CurrentHeatingCoolingState,
      v => [ 'off', 'heat', 'cool' ][v]         || 'auto',
      v => ( { off : 0, heat : 1, cool : 2 }[v] || 3 ) // 3 === 'auto'
    ),
    _('thermostat_mode', Characteristic.TargetHeatingCoolingState,
      v => [ 'off', 'heat', 'cool' ][v]         || 'auto',
      v => ( { off : 0, heat : 1, cool : 2 }[v] || 3 ) // 3 === 'auto'
    ),
  ],

...
//  console.log('device: '+ JSON.stringify(device));
  ...
  device.on('$state', state =>
  {
    ...
    if ('onoff' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' onoff: ' + on.value + ' new: ' + variable , "info");
    ...
    if ('dim' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' dim: ' + dimVariable.value + ' new: ' + variable, "info");
    ...
    if ('volume_mute' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' volume_mute: ' + mute.value + ' new: ' + variable, "info");
    ...
    if ('volume_set' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' volume_set: ' + volume.value + ' new: ' + variable, "info");
    ...
    if ('light_hue' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' light_hue: ' + hue.value + ' new: ' + variable, "info");
    ...
    if ('light_saturation' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' light_saturation: ' + sat.value + ' new: ' + variable, "info");
    ...
    if (!'light_saturation' in device.capabilities && !'light_hue' in device.capabilities && 'light_temperature' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' light_temperature: ' + temp.value + ' new: ' + variable, "info");
    ...
    if ('alarm_motion' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' alarm_motion: ' + motion.value + ' new: ' + variable, "info");
    ...
    if ('measure_humidity' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' measure_humidity: ' + currentRelativeHumidity.value + ' new: ' + variable, "info");
    ...
    if ('measure_luminance' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' measure_luminance: ' + lightSensor.value + ' new: ' + variable, "info");
    ...
    if ('alarm_battery' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' alarm_battery: ' + statusLowBattery.value + ' new: ' + variable, "info");
    ...
    if ('measure_battery' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' measure_battery: ' + batteryLevel.value + ' new: ' + variable, "info");
    ...
    if ('measure_temperature' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' measure_temperature: ' + temperature.value + ' new: ' + variable, "info");
    ...
    if ('alarm_water' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' alarm_water: ' + leakDetected.value + ' new: ' + variable, "info");
    ...
    if ('alarm_smoke' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' alarm_smoke: ' + smokeDetected.value + ' new: ' + variable, "info");
    ...
    if ('measure_aqi' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' measure_aqi: ' + airQuality.value + ' new: ' + variable, "info");
    ...
    if ('alarm_contact' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' alarm_contact: ' + contactSensorState.value + ' new: ' + variable, "info");
    ...
    if ('locked' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' locked: ' + LockCurrentState.value + ' new: ' + variable, "info");
    ...
    if ('windowcoverings_state' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' currentPosition: ' + currentPosition.value + ' new: ' + variable, "info");
        currentPosition.setValue(variable);
        dimVariable.setValue(variable);
    ...
    if ('thermostat_mode' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' thermostat_mode: ' + targetHeatingCoolingState.value + ' new: ' + variable, "info");
    ...
    if ('target_temperature' in device.capabilities)
    {
      ...
      {
        console.log('Update: '+ device.name + ' target_temperature: ' + targetTemperature.value + ' new: ' + variable, "info");
